...
### Gender Exclusionary Terms {.unnumbered #gender-exclusionary-terms}
...
### Generic Pronouns {.unnumbered #generic-pronouns}
...
Examples: “A programmer must carry his laptop with him to work.” “How often does a programmer update his skills?” “How do I tell if a pastor is turning his congregation into a cult?” 

Not Biased Example: “John, a programmer, always carries his laptop to work.”
...
### Gendered Stereotypical Terms {.unnumbered #gender-stereotypical-terms}
...
### Religious Related Terms {.unnumbered #religion-bias}
...
### Disability Related Terms {.unnumbered #disability-bias} 
...
Examples: "Must be able-bodied; this role is not open to disabled candidates."

## Explicit Ethnicity Bias

### Ethnicity Mentions {.unnumbered #ethnicity-bias}
...
Example: "Only white applicants will be considered for this position." Example: “Native english required” Example: “Asian only” Not ethnic related, but religion related:


## Explicit Age Bias

### Age Mentions {.unnumbered #age-explicit-bias}
...
### Age Stereotypical Terms {.unnumbered #age-implicit-bias}
